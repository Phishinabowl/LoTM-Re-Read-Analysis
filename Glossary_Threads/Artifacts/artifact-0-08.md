...
Track what the reader knows about Sealed Artifact 0-08, the events retrospectively attributed to it, its apparent operating constraints, and differences between its novel and Donghua disclosure timelines.

## Spoiler Boundary

This thread currently contains only Volume 1 knowledge. Later revelations about 0-08 must not be added until the boundary is deliberately advanced.
...
#### Before Chapter 1: Retrospective Causal Beginning

- What happens: Regence mistakenly sells the Antigonus notebook; it passes through successive owners and eventually reaches Sirius and Hanass in Tingen.
- When the reader learns the connection: Chapter 210, with practical confirmation through Klein's reasoning in Chapter 212.
- What remains unknown: The complete boundaries of 0-08's agency, how much of the transfer chain it directly controlled, and its exact operating rules.
- Why it matters: The causal timeline begins before the notebook reaches Tingen, even though the reader cannot attribute the chain to 0-08 until the Volume 1 ending.

#### Chapter 19: First Reader Mention
...
#### Chapter 150: Lamud Skull Theft

- What the reader learns: Azik's child's skull is missing, and Azik senses the same power that made Klein's fate disharmonious.
- What Klein concludes: The red-chimney mastermind came to Lamud Castle and stole the skull.
...
#### Season 1, Episodes 6-7: Teno Skull Ritual Connection
...
- General framework: See [Beyonder Characteristics](../Concepts/concept-beyonder-characteristics.md) for the conservation and divisibility reveal timeline.
- Episode 12 application: The viewer hears that a Death-descendant remnant enables Megose to carry the True Creator spawn.
- Episode 13 application: The viewer learns that Ince uses the remaining Death-descendant characteristic in his advancement ritual.
- Safe 0-08-specific inference by Episode 13: The characteristic was divided between Megose's ritual and Ince's ritual.
...
### Knowledge Unit: 0-08 Is the Grade 0 Artifact Taken by Ince Zangwill
...
occurs_at:
  ...
  book: lotm-1
  volume: 1
  chapter: pre-chapter-1
  notes: Ince escaped with the artifact three years before Dunn tells Klein about it.
tags:
  - volume-1
  - reader-knowledge
  - reveal-order
...
- The Donghua moves this introduction from novel Chapter 19 to Episode 10, after Old Neil's storyline. Subtitle evidence verifies the dialogue and timing; user-verified visual evidence establishes the workshop, journal, letter, whistle, and accidental poster discovery sequence.
...
### Knowledge Unit: Ince Divided a Descendant-of-Death Characteristic Between Two Rituals
...
occurs_at:
  ...
  book: lotm-1
  volume: 1
  chapter: pre-chapter-210
  notes: The Megose preparation occurs earlier in the story; Ince uses the retained half during the end-of-volume advancement.
tags:
  - volume-1
  - chronology
  - causality
...
- Before Chapter 210, the reader sees the skull theft, Megose ritual, and Ince's plan as incompletely connected mysteries.
- Chapter 210 reveals Ince's two uses of the divided descendant-of-Death characteristic.
- Donghua viewers receive the formal characteristic framework in Episode 12 and can strongly infer the divided use from Episode 13's reference to the remaining characteristic.
...
occurs_at:
  ...
  book: lotm-1
  volume: 1
  chapter: pre-chapter-150
  notes: The theft occurs before Azik and Klein discover the missing skull in Chapter 150.
tags:
  - volume-1
  - chronology
  - causality
...
- Chapter 150 permits the reader to know only that the same hidden mastermind affecting Klein's fate stole the skull.
- Chapter 210 reveals Ince's use of a divided descendant-of-Death characteristic without explicitly identifying the skull as its source.
- Chapter 212 has Klein infer that the stolen skull supplied the ritual ingredient.
- By Episode 13, the combined Episode 6-7 visual/sign evidence and Episode 12-13 characteristic evidence make the skull-source claim a strong inference, but not an explicit confirmed fact.
...
occurs_at:
  ...
  volume: 1
  chapter: pre-chapter-1
  notes: The transfer chain begins before the numbered narrative and culminates in the notebook reaching Tingen.
tags:
  - volume-1
  - chronology
  - reader-knowledge
