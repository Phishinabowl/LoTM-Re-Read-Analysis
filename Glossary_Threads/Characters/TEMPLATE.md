...
Use separate medium subsections when the character tracks more than one format.

### Novel

Use a single block only when all reveal beats happen together. If the character has layered disclosure, duplicate the beat heading pattern below as needed.
...
- Type:
- Function:
- First reveal / change point:
- Status:
- Confidence:
- Related concept: [Prayers & Rituals](../Concepts/concept-prayers-and-rituals.md)

```text
Exact reader-safe wording, if applicable.
```
