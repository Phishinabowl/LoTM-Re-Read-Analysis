...
This directory contains the portable V31-V37 occurrence, recurrence, policy, and subject-state fixture corpus.
...
The paired conformance tools add fourteen in-memory extension assertions. They introduce synthetic owning-pattern and external-pattern effects, global and same-target incompatibility, malformed semantic declarations, and idempotent, accumulating, and invalid repetition through pack vocabulary alone. The combined reported total is therefore 67 assertions.
