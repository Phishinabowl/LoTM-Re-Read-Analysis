...
`Occurrence/` contains the portable V31-V32 occurrence and recurrence corpus. Its valid schema-2 fixture keeps repeated occurrences distinct at one chronology coordinate, permits coherent incomparable primary coordinates, orders participant tracks across loop resets, nests a recurrence, exercises all core transition profiles, carries specifically identified internal and externally supplied payloads between participating iterations, forks and merges branches explicitly, and permits a causal cycle without weakening chronological order. Twenty-seven mutation cases reject malformed topology, iteration identity, contradictory or duplicate bindings, mismatched kinds and profiles, backward track transitions, invalid profile scopes, semantic duplicates, unknown payloads, ungrounded carryover, subjects, and fork references or ownership.
