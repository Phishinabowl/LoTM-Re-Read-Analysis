...
- `base/` provides a valid schema-4 three-pack composition with dependency ordering, capability lifecycle and activation, multiple capability providers, cross-pack controlled-value hierarchy, typed occurrence semantic declarations, one used four-dimension state profile plus kind mapping, and one dormant reusable profile.
