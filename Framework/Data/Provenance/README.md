...
Coverage includes assertion shape consistency, typed subject lookup including recurrence-cardinality, occurrence-participation, occurrence-track-entry, occurrence-branch-state-transition, and subject-state-transition targets, field paths including epistemic completeness, evidence roles, point and range locators, source coverage, observation and effective timing, claim applicability, supersession integrity, authority outcomes, and deterministic scale behavior.
