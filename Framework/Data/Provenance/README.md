...
Coverage includes assertion shape consistency, typed subject lookup including recurrence-cardinality targets, field paths, evidence roles, point and range locators, source coverage, observation and effective timing, claim applicability, supersession integrity, authority outcomes, and deterministic scale behavior.
