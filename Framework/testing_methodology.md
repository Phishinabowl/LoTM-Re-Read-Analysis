...
| --- | --- | --- | --- | --- | --- |
| `CONF-PACK-COMPOSITION` | Canonical eight-pack project plus neutral schema-4 three-pack fixture | 57 structured invalid compositions | Dependency order/version, lifecycle, activation, four-dimension typed semantic closure including dormant reusable state profiles and required kind mappings, and fail-fast orphan rejection | Duplicate providers, controlled-value ownership, hierarchy cycles, typed member collisions, profile ownership/mapping conflicts, and conflict-scope collisions | Generated 64-pack composition with 64 typed declarations plus two delimiter-colliding typed pairs |
