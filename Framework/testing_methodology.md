...
| V45-V48: competing structures, participant-relative chronology, hosted identity/embodiment, and bounded nested carrier topology | `CONF-INTERPRETATION`, `CONF-OCCURRENCE`, `CONF-HOSTING`, `CONF-ENTITY`, `CONF-RECONCILIATION`, `CONF-PROVENANCE`, `CONF-PROJECT-COMPOSITION`, `SCENARIO-PRIMER`, `SCENARIO-MEMENTO`, `SCENARIO-DOCTOR-WHO`, `SCENARIO-ARRIVAL`, `SCENARIO-WESTWORLD`, `SCENARIO-CONTINUITY-IDENTITY`, `PRESSURE-STRUCTURAL-INTERPRETATION`, `PRESSURE-PARTICIPANT-CHRONOLOGY`, `PRESSURE-HOSTED-IDENTITY`, `PRESSURE-ENTITY-IDENTITY`, `PRESSURE-EVIDENCE-AUTHORITY`, `PRESSURE-CROSS-DOMAIN`, `PRESSURE-ADVERSARIAL`, and `PRESSURE-SCALE`. |
