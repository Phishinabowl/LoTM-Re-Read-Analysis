...
| `CONF-HOSTING` | Canonical empty project registry plus three carriers, nine occupancies, move/copy/handoff transitions, active/co-resident/dormant occupancy, and single/co-controller queries | 31 malformed, provider, and capability configurations plus seven invalid queries | Inclusive activation, exclusive termination, carrier/occupancy containment, exact transition occurrence/entry binding, active copy source, and deterministic controller sets without invented priority | Duplicate providers and semantic records, multiple occupants/controllers, unsupported identity targets, and explicit non-inference across shared carriers | Generated 128-carrier and 128-occupancy composition |
