...
| Effective-schema shape, lifecycle resolution, diagnostics, ordering, serialization, or consumer adoption | `CONF-EFFECTIVE-SCHEMA`, `CONF-PROJECT-COMPOSITION`, `CONF-PACK-COMPOSITION`, taxonomy and resource conformance, deterministic repeated serialization from repository and unrelated working directories, exact-path shadow mismatch coverage, Python/PowerShell canonical JSON parity, malformed/failure-envelope coverage, and every adopted QA or Visualization compatibility profile. |
