...
| `CONF-HOSTING` | Canonical empty project registry plus three carriers, six occupancies, move/copy/handoff transitions, co-residence, and controller queries | 31 malformed, provider, and capability configurations plus seven invalid queries | Inclusive activation, exclusive termination, carrier/occupancy containment, exact transition occurrence/entry binding, and active copy source | Duplicate providers and semantic records, multiple occupants/controllers, unsupported identity targets, and explicit non-inference across shared carriers | Generated 128-carrier and 128-occupancy composition |
...
| `SCENARIO-WESTWORLD` | Externally source-grounded hosted-identity stress case. Can the model distinguish conceptual identity, incarnation, phase, persona, copied or diverged mind, control unit, physical or virtual carrier, occupancy, and active control? It must permit co-residence and transfer without inferring equivalence, persistence, replacement, or truth from shared code, body, memory, or appearance. |
...
| `PRESSURE-HOSTED-IDENTITY` | Can stable identity, incarnation, identity phase, persona, carrier, occupancy, control, transfer, copy, derivation, and divergence remain distinct? Test one identity across carriers, several identities in one carrier, dormant and active co-residence, changing control, destroyed or replaced carriers, copied minds that later diverge, physical and virtual hosts, and provenance at explicit boundaries. Replay Westworld plus software process/container, agent/runtime, avatar, and simulation cases without importing narrative body semantics into core. |
...
| Hosted identity, carrier, occupancy, control, transfer, copy, or divergence semantics | `CONF-ENTITY`, `CONF-OCCURRENCE`, `CONF-RECONCILIATION`, `PRESSURE-HOSTED-IDENTITY`, `PRESSURE-ENTITY-IDENTITY`, `SCENARIO-WESTWORLD`, `SCENARIO-CONTINUITY-IDENTITY`, provenance targets, lifecycle boundaries, and physical/virtual cross-domain probes. |
