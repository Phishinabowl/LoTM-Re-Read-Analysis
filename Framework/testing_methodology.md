...
| `CONF-CHRONOLOGY` | Verify coordinate systems, exact/partial ordering, spans, mappings, cycles, eras, context identity, directed non-precedence topology, deterministic incoming/outgoing queries, typed binding closure, canonical chronology-position provenance lookup and scale, context provenance targets, and coordinate incomparability despite topology. | `Tools/Conformance/Suites/test_chronology.py`, `Tools/Conformance/Suites/Test-Chronology.ps1`, and `Framework/Data/Chronology/`. |
