...
| `CONF-PROJECT-COMPOSITION` | Two deterministic complete canonical loads | Eight missing, duplicate, unregistered, or capability-disabled compositions | Exact manifest paths/schemas plus available, enabled, and disabled capability boundaries | Reconciliation/provenance provider closure and duplicate-provider rejection | Reviewed exact oracle spanning eight packs, 116 enabled capabilities, 937 controlled values, and 56 provenance subject types |
...
| V31-V40: occurrences, recurrences, transitions, state acquisition, policy, schedules, extension semantics, effect resolution, aggregate/uncertain cardinality, participation identity, and revisited occurrences | `CONF-OCCURRENCE`, `CONF-PROVENANCE`, `CONF-PROJECT-COMPOSITION`, `PRESSURE-RECURRENCE-STATE`, `SCENARIO-DERRICK`, `SCENARIO-LOKI`, `PRESSURE-EVIDENCE-AUTHORITY`, `PRESSURE-TEMPORAL-TOPOLOGY`, `PRESSURE-CROSS-DOMAIN`, `PRESSURE-ADVERSARIAL`, and `PRESSURE-SCALE`. |
