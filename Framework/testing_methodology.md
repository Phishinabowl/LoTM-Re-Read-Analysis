...
| `CONF-PROVENANCE` | Canonical registry plus 16 neutral assertions, supersession, locators, and five authority decisions | 68 structured invalid configurations and five invalid queries | Field paths including recurrence-cardinality, occurrence-participation, and occurrence-track-entry fields, source coverage, point/range locators, observation/effective windows, applicability, and supersession | Corroborating ties, equal-rank conflicts, incomparable evidence, duplicate evidence, and target/provider ambiguity | Generated 128-assertion extension |
| `CONF-OCCURRENCE` | Canonical registry plus neutral participation, recurrence, cardinality, policy, and subject-state fixture | 102 structured invalid configurations | Revisited occurrences, participation role/perspective/status/context, semantically identical encounters ordered by a shared track, stable track-entry order, exact/minimum/maximum/range/unknown cardinality, complete/representative/unmaterialized coverage, lifecycle, schedules, applicability, authorization, and signed-64-bit count boundaries | Repeated-occurrence navigation and occurrence-level transition/state ambiguity, unexplained semantic duplicate participations, semantic duplicate cardinalities, invalid track ownership/order, conflicting outcomes/effects, indeterminate applicability, cross-recurrence representatives, and provider closure | Generated 128-cardinality and 128-participation/track-entry extensions plus retained semantic-effect probes |
| `CONF-PROJECT-COMPOSITION` | Two deterministic complete canonical loads | Nine missing, duplicate, unregistered, or capability-disabled compositions | Exact manifest paths/schemas plus available, enabled, and disabled capability boundaries | Reconciliation/provenance provider closure, chronology-context typed-target closure, and duplicate-provider rejection | Reviewed exact oracle spanning eight packs, 118 enabled capabilities, 955 controlled values, and 59 provenance subject types |
...
| V31-V41: occurrences, recurrences, transitions, state acquisition, policy, schedules, extension semantics, effect resolution, aggregate/uncertain cardinality, participation identity, revisited occurrences, and chronology-context topology | `CONF-OCCURRENCE`, `CONF-CHRONOLOGY`, `CONF-PROVENANCE`, `CONF-PROJECT-COMPOSITION`, `PRESSURE-RECURRENCE-STATE`, `SCENARIO-DERRICK`, `SCENARIO-LOKI`, `PRESSURE-EVIDENCE-AUTHORITY`, `PRESSURE-TEMPORAL-TOPOLOGY`, `PRESSURE-CROSS-DOMAIN`, `PRESSURE-ADVERSARIAL`, and `PRESSURE-SCALE`. |
