...
| --- | --- | --- | --- | --- | --- |
| `CONF-PACK-COMPOSITION` | Canonical eight-pack project plus neutral schema-3 three-pack fixture | 52 structured invalid compositions | Dependency order/version, lifecycle, activation, typed semantic closure, and fail-fast orphan rejection | Duplicate providers, controlled-value ownership, hierarchy cycles, typed member collisions, and conflict-scope collisions | Generated 64-pack composition with 64 typed declarations plus two delimiter-colliding typed pairs |
...
| `CONF-PROVENANCE` | Canonical registry plus 17 neutral assertions, supersession, locators, and five authority decisions | 68 structured invalid configurations and five invalid queries | Field paths including branch-state, recurrence-cardinality, occurrence-participation, and occurrence-track-entry fields, source coverage, point/range locators, observation/effective windows, applicability, and supersession | Corroborating ties, equal-rank conflicts, incomparable evidence, duplicate evidence, and target/provider ambiguity | Generated 128-assertion extension |
| `CONF-OCCURRENCE` | Canonical registry plus neutral branch-lifecycle, participation, recurrence, cardinality, policy, and subject-state fixture | 118 structured invalid configurations | Stable branch identity, continuity closure, branch-local contiguous state history through emergence, activation, pruning, transfer, restoration, and merge, required fork/merge triggers, state boundary zero/latest/large lookup, revisited occurrences, participation role/perspective/status/context, semantically identical encounters ordered by a shared track, stable track-entry order, exact/minimum/maximum/range/unknown cardinality, complete/representative/unmaterialized coverage, recurrence lifecycle, schedules, applicability, authorization, and signed-64-bit count boundaries | Unknown branches or continuity memberships, broken lifecycle chains, missing or mismatched fork/merge triggers, repeated-occurrence navigation and occurrence-level transition/state ambiguity, unexplained semantic duplicate participations, semantic duplicate cardinalities, invalid track ownership/order, conflicting outcomes/effects, indeterminate applicability, cross-recurrence representatives, and provider closure | Generated 128-branch-state, 128-cardinality, and 128-participation/track-entry extensions plus retained semantic-effect probes |
| `CONF-PROJECT-COMPOSITION` | Two deterministic complete canonical loads | Ten missing, duplicate, unregistered, or capability-disabled compositions | Exact manifest paths/schemas plus available, enabled, and disabled capability boundaries | Reconciliation/provenance provider closure, chronology-context and branch-continuity typed-target closure, and duplicate-provider rejection | Reviewed exact oracle spanning eight packs, 119 enabled capabilities, 972 controlled values, and 60 provenance subject types |
...
| Occurrence, participation, track-entry, recurrence, state, or effect semantics | `CONF-OCCURRENCE`, `PRESSURE-RECURRENCE-STATE`, Derrick and Loki scenarios, repeated observation/review/intervention probes, cross-domain pressure, provenance targets, and project compatibility. |
