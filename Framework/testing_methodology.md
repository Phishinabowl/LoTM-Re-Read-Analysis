...
| `CONF-PROVENANCE` | Verify assertion shape and grouping, typed cross-registry subjects including occurrence and recurrence-cardinality fields, semantic field paths, evidence roles and locators, source scope and coverage, observation/effective timing, claim applicability, acyclic supersession, winner/tie/conflict/incomparable authority decisions, malformed configuration, invalid queries, and scale without freezing project facts. | `Tools/Conformance/Suites/test_provenance.py`, `Tools/Conformance/Suites/Test-Provenance.ps1`, and `Framework/Data/Provenance/`. |
...
| `CONF-PROVENANCE` | Canonical registry plus 14 neutral assertions, supersession, locators, and five authority decisions | 68 structured invalid configurations and five invalid queries | Field paths including recurrence-cardinality fields, source coverage, point/range locators, observation/effective windows, applicability, and supersession | Corroborating ties, equal-rank conflicts, incomparable evidence, duplicate evidence, and target/provider ambiguity | Generated 128-assertion extension |
| `CONF-OCCURRENCE` | Canonical registry plus neutral recurrence, cardinality, policy, and subject-state fixture | 87 structured invalid configurations | Exact/minimum/maximum/range/unknown cardinality, complete/representative/unmaterialized coverage, lifecycle, schedules, applicability, authorization, and signed-64-bit count boundaries | Semantic duplicate cardinalities, conflicting outcomes/effects, indeterminate applicability, cross-recurrence representatives, and provider closure | Generated 128-cardinality extension plus retained semantic-effect probes |
| `CONF-PROJECT-COMPOSITION` | Two deterministic complete canonical loads | Seven missing, duplicate, unregistered, or capability-disabled compositions | Exact manifest paths/schemas plus available, enabled, and disabled capability boundaries | Reconciliation/provenance provider closure and duplicate-provider rejection | Reviewed exact oracle spanning eight packs, 115 enabled capabilities, 920 controlled values, and 54 provenance subject types |
...
| V31-V39: occurrences, recurrences, transitions, state acquisition, policy, schedules, extension semantics, effect resolution, and aggregate/uncertain cardinality | `CONF-OCCURRENCE`, `CONF-PROVENANCE`, `CONF-PROJECT-COMPOSITION`, `PRESSURE-RECURRENCE-STATE`, `SCENARIO-DERRICK`, `SCENARIO-LOKI`, `PRESSURE-EVIDENCE-AUTHORITY`, `PRESSURE-TEMPORAL-TOPOLOGY`, `PRESSURE-CROSS-DOMAIN`, `PRESSURE-ADVERSARIAL`, and `PRESSURE-SCALE`. |
