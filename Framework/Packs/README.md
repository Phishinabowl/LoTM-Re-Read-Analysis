...
Schema-6 capability groups are stable wizard/editor navigation units. One pack owns each group's
identity and presentation; that pack and its dependents may contribute capabilities without
transferring capability ownership. Capability requirements, recommendations, and conflicts are
explicit declarations. Hard requirements must remain acyclic, recommendations never imply
activation, and conflicts remain explainable metadata until project policy resolves them.
