...
Select an authority profile before making cross-work canon judgments. Authority profiles define accepted continuity memberships, continuity order, comparable derivative-work relationships, and source-priority direction. In `lotm-narrative`, lower source numbers have higher authority: primary novel editions are priority 1 and the Donghua release/transcript are priority 2. Under `lotm-adaptation-comparison`, preserve both source-scoped claims, treat the novel continuity as the primary comparison authority, and attach deviations to the derivative Donghua work. Numeric priority alone never makes unrelated works comparable and never advances another work or medium's spoiler state.
