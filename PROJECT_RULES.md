...
`Project_Config/sources.yaml` is the machine-readable authority for work groups, works, work segments, named ordering schemes, continuities, authority profiles, per-work volumes, adaptation mappings, evidence sources, media facets, typed work/source relationships, position schemas, citation formats, aliases, evidence modes, comparison groups, priority, container formats, and bindings to registered resources. Work groups represent franchises, ordered series, heterogeneous adaptation programs, or collections. Works represent creative units; release forms distinguish novels, television seasons, specials, films, and other packaging while medium profiles retain reader-position behavior. Segments provide configurable chapter, issue, episode, scene, or other work-part identity. Named ordering schemes preserve publication, release, story, production, and recommended orders independently. Continuities model compatible canon scopes. Sources represent concrete editions, releases, transcripts, subtitle tracks, scans, extracts, or other evidence artifacts and declare their containers separately. Do not collapse those layers.
