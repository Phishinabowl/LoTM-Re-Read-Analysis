...
Last focused parity check: 2026-08-05. Python, PowerShell 7, and Windows PowerShell 5.1 loaded manifest schema 9, schema-pack selection registry schema 2, schema-3 pack files, eight selected packs (`core` 31, `narrative-media` 21, `narrative-publishing` 10, `narrative-screen-audio` 11, `narrative-adaptation` 10, `narrative-distribution` 14, `narrative-production` 4, and `narrative-shared-universe` 9), taxonomy schema 2, resource schema 1, source schema 18, entity schema 4, reconciliation schema 4, provenance schema 3, chronology schema 1, occurrence schema 6, and lookup-key schema 1 with Unicode 16.0.0. V40 adds provenance-addressable occurrence-participation identity and ordered track entries, including deterministic repeated participation by one subject in a single occurrence. The current composition contains 122 atomic controlled-value namespaces, 937 values, 116 enabled capabilities, and 56 provenance subject types. The LoTM occurrence instance still contains only `main`; no loop, participation, or repetition count is fabricated. Focused occurrence conformance passed 80 query/evaluation assertions, 102 malformed cases, and generated 128-record cardinality and participation/track-entry scale probes with matching summaries in all three runtimes; project composition, schema-pack composition, and provenance conformance also passed.
...
Last parity check: 2026-08-05 for V40 implementation closure. The `baseline` profile passed all fourteen registered suites in Python, PowerShell 7, and Windows PowerShell 5.1 with matching suite IDs, statuses, and canonicalized semantic summaries. Measured local runtimes were 47.4 seconds, 171.8 seconds, and 281.6 seconds respectively. The baseline verifies the reviewed project identity, eight selected packs, 116 enabled and nine disabled capabilities, 24 reconciliation target types, 56 provenance subject types, exact registry schemas/counts and typed semantic declarations, provider and object closure, deterministic repeated loads, disabled-capability absence, and eight invalid cross-registry compositions. Schema-pack pressure includes 64 generated typed declarations; occurrence conformance includes 80 query/evaluation assertions, 102 malformed cases, 128 generated cardinality records, and 128 generated participation/track-entry records; provenance conformance includes 16 fixture assertions and five authority vectors. Source, entity, provenance, and project composition remain outside the eight-suite `fast` profile because their repeated dependency composition is materially expensive.
