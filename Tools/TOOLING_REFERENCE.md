...
Last parity check: 2026-08-01. Python, PowerShell 7, and Windows PowerShell 5.1 loaded manifest schema 7, schema-pack registry schema 2, eight selected packs (`core` 20, `narrative-media` 15, `narrative-publishing` 10, `narrative-screen-audio` 11, `narrative-adaptation` 10, `narrative-distribution` 14, `narrative-production` 4, and `narrative-shared-universe` 9), taxonomy schema 2, resource schema 1, source schema 18, entity schema 4, reconciliation schema 4, provenance schema 3, and lookup-key schema 1 with Unicode 16.0.0. V29 hardens the shared temporal kernel with canonical six-digit fractional resolution, safe UTC/calendar extremes, explicit known versus unknown bounds, complete-unit year/month/date queries, partial-intersection reporting, and certainty-specific indeterminate outcomes. Seventeen valid windows, eighteen malformed windows, twenty query matches, and twelve overlap vectors pass identically in all three runtimes. V28 shared temporal ownership, V27 canonical mapping keys, V26 byte/scalar probes, 40 malformed reconciliation fixtures, branch/step limits, and the 1,500-hop chain remain permanent regression baselines alongside V25 closed shapes, V24 strict ingestion, V23 branch-aware identity, V22 provider/provenance, V21 identity phases, V20 provenance, V19 lookup, V18 entity lineage, V15 source applicability, and V14 storage.
