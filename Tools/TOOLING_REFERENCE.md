...
Last parity check: 2026-07-31. Python, PowerShell 7, and Windows PowerShell 5.1 loaded manifest schema 7, schema-pack registry schema 2, eight selected packs (`core` 16, `narrative-media` 15, `narrative-publishing` 10, `narrative-screen-audio` 11, `narrative-adaptation` 10, `narrative-distribution` 13, `narrative-production` 4, and `narrative-shared-universe` 9), taxonomy schema 2, resource schema 1, source schema 16, entity schema 4, reconciliation schema 4, provenance schema 1, and lookup-key schema 1 with Unicode 16.0.0. All runtimes resolved 111 declared capabilities, 102 available capabilities, 102 explicitly enabled capabilities, and 714 controlled-value ownership records. V25 fixtures validate the canonical cross-runtime YAML scalar subset; reject tags, anchors, aliases, merge keys, document markers, and malformed RFC 3339 edge cases; enforce closed framework registry shapes and parser budgets; require redirect-only compatibility for active present sources; and bound reconciliation records, direct targets, branches, and traversal steps. V24 strict-ingestion, V23 branch-aware identity, V22 provider/provenance, V21 identity-phase, V20 provenance, V19 lookup, V18 entity-lineage, V15 source-applicability, and V14 storage fixtures remain regression baselines.
