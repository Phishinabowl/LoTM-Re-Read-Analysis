...
| `Project_Config/entities.yaml` | Entity/incarnation registry | `Tools/entity_config.py`, `Tools/Entity-Config.ps1`, and future provenance, content-index, visualization, editor, and migration services | Maintainers through reviewed edits; future entity editors through the mutation service | Instantiates multi-category conceptual entities, typed entity lineage and basis roles, continuity-bound incarnations, scope-backed material bindings, and inverse-aware typed incarnation relationships without conflating them with pages, portrayals, or manifestations. | A category membership, same-continuity entity relationship, justified incarnation split, continuity membership, scoped appearance, alias, or incarnation relationship changes. |
...
| Resolve entity and incarnation IDs or aliases | `EntityRegistry.resolve_entity_id`, `resolve_incarnation_id` | `Resolve-KnowledgeEntityId`, `Resolve-KnowledgeIncarnationId` |
