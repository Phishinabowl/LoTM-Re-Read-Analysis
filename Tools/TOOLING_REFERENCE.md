...
Last focused parity check: 2026-08-05. Python, PowerShell 7, and Windows PowerShell 5.1 load manifest schema 10, schema-pack selection registry schema 2, schema-4 pack files, eight selected packs (`core` 37, `narrative-media` 24, `narrative-publishing` 10, `narrative-screen-audio` 11, `narrative-adaptation` 10, `narrative-distribution` 14, `narrative-production` 4, and `narrative-shared-universe` 9), taxonomy schema 2, resource schema 1, source schema 18, entity schema 4, reconciliation schema 4, chronology schema 2, occurrence schema 10, interpretation schema 1, provenance schema 3, and lookup-key schema 1 with Unicode 16.0.0. V46 adds stable participation- and track-entry-relative chronology links plus exact entry-relative state boundaries without duplicating occurrences or creating chronology edges. The current composition contains 132 atomic controlled-value namespaces, 1,014 values, four state profiles, 18 state-kind mappings, 122 enabled capabilities, and 66 provenance subject types. Focused occurrence conformance passes 139 query/evaluation assertions, 160 invalid configurations, and generated 128-record chronology-link probes; provenance validates 21 composed assertions including the new chronology-link target.
...
Last parity check: 2026-08-05 for V46 implementation. The `baseline` profile passed all fifteen registered suites in Python, PowerShell 7, and Windows PowerShell 5.1 with matching suite IDs, statuses, and canonicalized semantic summaries. Individually measured runtimes were 41.1, 187.3, and 348.7 seconds. The baseline verifies the reviewed project identity, eight selected packs, 122 enabled and nine disabled capabilities, 24 reconciliation target types, 66 provenance subject types, exact registry schemas/counts and typed semantic declarations including four state profiles and 18 state-kind mappings, provider and object closure, deterministic repeated loads, disabled-capability absence, and thirteen invalid cross-registry compositions. Occurrence conformance includes 139 query/evaluation assertions, 160 malformed registries, and generated 128-record branch-state, cardinality, participation/track-entry, and participation-chronology-link probes. The `full-release` compatibility profile passed all six checks in 169.9 seconds, preserving 15 visualization nodes, 121 relationships, 16 QA notes, 34 normalized QA files, 12 root launches, artifact safety, 217-file isolated framework extraction, and identical nonblank rendering across runtimes. Source, entity, provenance, interpretation, and project composition remain outside the eight-suite `fast` profile because their repeated dependency composition is materially expensive.
