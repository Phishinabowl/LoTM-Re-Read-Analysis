...
| `Project_Config/sources.yaml` | Source registry | `Tools/source_config.py`, `Tools/Source-Config.ps1`, and future validation, content-index, visualization, editor, and migration services | Maintainers through reviewed edits; future source editors through the mutation service | Instantiates media modalities, cultural forms, release forms, container formats, medium position profiles, work groups, continuities, authority profiles, works, segments, named orderings, adaptation mappings, sources, aliases, priority, relationships, and resource bindings. | A media facet, group, continuity, profile, work, segment, ordering, mapping, volume, source, or binding changes. |
...
Last parity check: 2026-07-31. Python, PowerShell 7, and Windows PowerShell 5.1 loaded manifest schema 3, schema-pack registry schema 2, five selected schema packs at pack schema 2, taxonomy schema 2, resource schema 1, and source schema 3. The source registry matched at three media modalities, one cultural form, three release forms, four container formats, three medium profiles, four work-group types, three work groups, two continuities, one continuity relationship, two authority profiles, six works, zero registered segments, two named ordering schemes, eight verified Book 1 volume ranges, five work relationships, zero segment adaptation mappings, eight evidence sources, fourteen source aliases, two source relationships, four source-resource bindings, and twelve work aliases. All runtimes resolved 44 declared capabilities, 38 available capabilities, 38 explicitly enabled capabilities, and 235 controlled-value ownership records. The six planned unavailable capabilities are `migration-services`, `scoped-continuity`, `entity-incarnations`, `retcon-supersession`, `textual-witnesses`, and `editorial-assembly`. A 314-record normalized pack/source projection produced the identical SHA-256 semantic hash `959355b44290468955f268a9cd22cf1111662b10f1f84c8d5206319bf3496bed` in all three runtimes. Both QA exporters generated matching 28-file lists and summary counts; the 25 stable outputs matched after generated timestamps were normalized, leaving only the three expected runtime-specific refresh artifacts.
...
`Project_Config/sources.yaml` separates media facets, work groups, continuities, creative works, work segments, named orderings, adaptation mappings, and evidence sources. A medium is specifically a reader-position/citation profile and references one or more modalities plus compatible cultural forms. Works separately declare release form and lifecycle status; sources separately declare their concrete container formats. This allows a Donghua film or EPUB-contained illustration to retain every relevant axis without compound medium IDs. Work groups may represent franchises, ordered series, heterogeneous adaptation programs, or unordered collections and may nest beneath a parent group. A work defines stable identity, group and continuity memberships, display aliases, numbering mode, release form, status, and a verified, pending, or inapplicable volume catalog.

Segments provide stable configurable parts beneath a work, while named ordering schemes can order works or segments by release, publication, story, production, or recommendation without overwriting another order. Adaptation mappings connect works and optional registered segments using controlled correspondence types. A source selects a work and medium profile and defines a concrete evidence role, containers, comparison group, priority, aliases, evidence modes, and optional bindings to registered resources.
...
The paired source loaders reject malformed IDs, invalid position/citation definitions, unknown media-facet/group/continuity/profile/work/segment/medium/container/resource/source references, incompatible cultural forms and modalities, invalid group or segment nesting and cycles, duplicate ordering targets or ordinals, missing or duplicate ordered-group ordinals, malformed or non-contiguous verified volume catalogs, unsupported roles/statuses/policies/mapping types, duplicate aliases, malformed inverse-type definitions, invalid or self-referential typed relationships, cross-work segment mappings, escaping or out-of-placement resource paths, and missing required bindings.
