...
$projectHelper = Join-Path $PSScriptRoot 'Project-Config.ps1'
. $projectHelper
$packHelper = Join-Path $PSScriptRoot 'Schema-Pack-Config.ps1'
. $packHelper
$resourceHelper = Join-Path $PSScriptRoot 'Resource-Config.ps1'
. $resourceHelper
$sourceHelper = Join-Path $PSScriptRoot 'Source-Config.ps1'
. $sourceHelper
