...
Run the permanent stable-ID reconciliation vectors after changing reconciliation, provider, schema-pack, or lookup ownership behavior. Both tools validate branch-aware resolutions, malformed records, and a 1,500-hop chain; their temporary deep-chain files are removed automatically.
