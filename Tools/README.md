...
Run the permanent temporal vectors after changing shared time parsing, temporal pack vocabulary, source applicability, release/title windows, or provenance timing. Both implementations load `Framework/Data/Temporal/`, reject malformed windows, and verify identical point-match and window-overlap outcomes without leaving output files.
